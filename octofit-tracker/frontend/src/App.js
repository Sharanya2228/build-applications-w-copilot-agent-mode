    ...
    <Router>
      <div className="container mt-4">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card"><div className="card-body"><h1 className="card-title">Welcome to Octofit Tracker!</h1><p className="card-text">Track your fitness, join teams, and compete on the leaderboard.</p></div></div>} />
        </Routes>
      </div>
    </Router>
  );
