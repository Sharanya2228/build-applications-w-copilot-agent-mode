...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create workouts
        for user in users:
            Workout.objects.create(name='Morning Cardio', description='Cardio session', user=user)
            Workout.objects.create(name='Strength Training', description='Strength session', user=user)
